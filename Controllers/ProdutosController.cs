...
namespace BlueModasBack.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ProdutosController : ControllerBase
    {
        private readonly BlueModasBackContext _context;

        public ProdutosController(BlueModasBackContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Produtos>> PostProdutos(Produtos produtos)
        {
            ...
            return CreatedAtAction("GetProdutos", new { id = produtos._id }, produtos);
        }
        ...
        {
            return _context.Produtos.Any(e => e._id == id);
        }
    }
}
